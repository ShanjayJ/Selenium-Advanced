...
public class ExtentReport {
	...
	public void setUp() {
		...
		report = new ExtentReports(
				"F:\\Java Files\\Source code\\SeleniumAdvanced\\Extent Report\\extent-report.html", true);
	...
	public void publish(ITestResult rslt) throws IOException {
		...
		screenshot = "F:\\Java Files\\Source code\\SeleniumAdvanced\\Extent Report" + rslt.getName()
				+ ".png";
